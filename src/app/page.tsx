        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-[var(--muted)]">
              Separate from Polymarket Paper Lab · $1,000 / bot · paper only
            </p>
            <h2 className="mt-1 text-3xl font-semibold">
              Five CopyGrade wallets in paper
            </h2>
            <p className="mt-2 max-w-2xl text-[var(--muted)]">
              Each bot mirrors one CopyGrade shortlist wallet on Polymarket.
              Net PnL = equity − $1,000 after fees. This desk does not share
              state with the 100-bot Paper Lab.
            </p>
          </div>
